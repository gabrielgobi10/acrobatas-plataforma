...
export const LoginPage = () => {
  ...
  return (
    <div className="app-shell">
      {/* wrapper interno respeita safe-area e largura máxima */}
      <div className="app-shell-inner relative overflow-hidden flex flex-col">
        ...
        {/* 🚀 Mobile Dock (fica colado no fundo, independente da altura) */}
        <MobileDock />

        {/* 🔹 Container principal do conteúdo */}
        <div className="w-full max-w-5xl mx-auto flex flex-col md:grid md:grid-cols-2 gap-6 md:gap-8 items-stretch mt-4 sm:mt-8 mb-6">
          {/* ESQUERDA */}
