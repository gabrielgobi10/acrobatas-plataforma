...
export default function AcrobatasEmpresa() {
  ...
  // Loader central igual à página de Documentos dos Profissionais
  if (loading) {
    return (
      ...
      >
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Documentos institucionais da Acrobatas — disponíveis para consulta e
            download.
          </p>
        </div>
      </motion.div>
                      ...
                      <div>
                        ...
                        {arquivo && (
                          <p className="text-[11px] mt-1 text-gray-400 dark:text-gray-500">
                            Enviado em:{" "}
                            {new Date(arquivo.created_at).toLocaleDateString()}
                          </p>
                        )}
                      </div>
