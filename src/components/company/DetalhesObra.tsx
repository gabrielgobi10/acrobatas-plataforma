      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-6 sm:gap-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
          {[
            ...
            <motion.div
              ...
              className="bg-white dark:bg-[#1b2332] p-3 sm:p-4 rounded-lg sm:rounded-xl shadow-sm text-center border border-gray-100 dark:border-zinc-700 hover:shadow-md transition-all duration-200"
            >
        ...
        <div className="bg-white dark:bg-[#1b2332] p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-sm border border-gray-100 dark:border-zinc-700">
          ...
          <p className="text-right text-xs sm:text-sm text-gray-500 dark:text-gray-400 mt-1">
            {obra.progresso || 0}% {t("obra.concluido")}
          </p>
        </div>
          ...
          <div className="flex gap-2 sm:gap-3 border-b border-gray-200 dark:border-zinc-700 pb-3 w-max sm:w-full">
            {[
              ...
              <button
                ...
                className={`px-4 sm:px-5 py-1.5 sm:py-2.5 rounded-full text-xs sm:text-sm font-medium transition-all duration-200 whitespace-nowrap ${
                  abaAtiva === aba.id
        ...
        <motion.div
          ...
          className="bg-white dark:bg-[#1b2332] p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-sm border border-gray-100 dark:border-zinc-700"
        >
